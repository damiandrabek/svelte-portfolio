  ...
  let benefits = [
    {
      ...
      description:
        "I taught my self using free online resources and absolutely fell in love with the creativity and problem solving that is involved in developing and engineering innovative new online experiences.",
    },
    {
...
<main class="flex flex-col flex-1 p-4">
  ...
  >
    ...
    >
      ...
      <p class="text-base sm:text-lg md:text-xl">
        ...
        (SvelteKit or React), TailwindCSS, Node.js + Express.js & PostgreSQL or Firebase/Firestore!
      </p>
      <a
  ...
  <section id="projects" class="py-20 lg:py-32 flex flex-col gap-24">
    ...
    <a
      href="https://youtube.com/@damiandrabek"
      target="_blank"
  ...
  >
    ...
    >
      <h6 class="text-lg sm:text-xl md:text-2xl">What to know more?</h6>
      <h3 class="font-semibold text-3xl sm:text-4xl md:text-4xl">
        A bit <span class="poppins text-violet-400 k">about</span> me.
      </h3>
    </div>
    <p class="mx-auto poppins font-semibold text-lg sm:texl-xl md:text-2xl">
      I am . . .
    </p>
    ...
    <h5 class="text-2xl sm:text-3xl font-semibold text-center poppins">The <span class="text-violet-500 ">Complete</span> Package</h5>
    <div
      class="flex flex-col overflow-x-scroll gap-10 max-x-[800px] mx-auto w-full"
    >
